...
const rolePermissions = {
  ...
  'marketing-director': ['customer.view', 'marketing.view', 'marketing.contacts.view', 'marketing.contacts.import', 'marketing.templates.view', 'marketing.templates.manage', 'marketing.campaign.view', 'marketing.campaign.create', 'marketing.campaign.edit', 'marketing.campaign.approve', 'marketing.campaign.send', 'marketing.campaign.schedule', 'marketing.campaign.pause', 'marketing.whatsapp.manage', 'marketing.social.view', 'marketing.social.create', 'marketing.social.schedule', 'marketing.social.publish', 'marketing.social.delete', 'marketing.ads.view', 'marketing.ads.create', 'marketing.ads.edit', 'marketing.ads.publish', 'marketing.ads.analytics', 'marketing.content.view', 'marketing.content.upload', 'marketing.content.manage', 'marketing.calendar.view', 'marketing.calendar.manage', 'marketing.holidays.manage', 'marketing.ai.generate', 'marketing.approval.request', 'marketing.approval.approve', 'marketing.approval.reject', 'marketing.meta.connect', 'marketing.meta.manage', 'marketing.analytics.view', 'report.view', 'report.export', 'user.view'],
  'marketing-manager': ['customer.view', 'marketing.view', 'marketing.contacts.view', 'marketing.contacts.import', 'marketing.templates.view', 'marketing.templates.manage', 'marketing.campaign.view', 'marketing.campaign.create', 'marketing.campaign.edit', 'marketing.campaign.approve', 'marketing.campaign.send', 'marketing.campaign.schedule', 'marketing.campaign.pause', 'marketing.whatsapp.manage', 'marketing.social.view', 'marketing.social.create', 'marketing.social.schedule', 'marketing.social.publish', 'marketing.social.delete', 'marketing.ads.view', 'marketing.ads.create', 'marketing.ads.edit', 'marketing.ads.publish', 'marketing.ads.analytics', 'marketing.content.view', 'marketing.content.upload', 'marketing.content.manage', 'marketing.calendar.view', 'marketing.calendar.manage', 'marketing.holidays.manage', 'marketing.ai.generate', 'marketing.approval.request', 'marketing.approval.approve', 'marketing.approval.reject', 'marketing.meta.connect', 'marketing.meta.manage', 'marketing.analytics.view', 'report.view', 'user.view'],
  'marketing-executive': ['customer.view', 'marketing.view', 'marketing.contacts.view', 'marketing.contacts.import', 'marketing.templates.view', 'marketing.campaign.view', 'marketing.campaign.create', 'marketing.campaign.edit', 'marketing.social.view', 'marketing.social.create', 'marketing.social.schedule', 'marketing.ads.view', 'marketing.ads.create', 'marketing.content.view', 'marketing.content.upload', 'marketing.calendar.view', 'marketing.ai.generate', 'marketing.approval.request'],
  'marketing-analyst': ['customer.view', 'marketing.view', 'marketing.campaign.view', 'marketing.social.view', 'marketing.ads.view', 'marketing.ads.analytics', 'marketing.calendar.view', 'marketing.analytics.view', 'report.view'],
